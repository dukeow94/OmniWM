...
This page is the contributor entry point for the docs site. The canonical contribution guide lives in the repository root at [CONTRIBUTING.md](https://github.com/OmniNull/OmniWM/blob/main/CONTRIBUTING.md).

This page stays short on purpose so the actual project rules only have one source of truth.

## Start Here

- Read the [canonical contribution guide](https://github.com/OmniNull/OmniWM/blob/main/CONTRIBUTING.md).
...
- For the user-facing overview, installation notes, and screenshots, see the [README](https://github.com/OmniNull/OmniWM/blob/main/README.md).
